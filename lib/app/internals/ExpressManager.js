...
var ExpressManager = (function () {
    ...
    ExpressManager.prototype.exportPluginsStatics = function () {
        ...
        this.pluginRegistry.getUrlAndDirForEachStatics(function (pluginName, url, dir) {
            _this.exportStatic(url, dir);
    ...
    ExpressManager.prototype.exportApplicationStatics = function () {
        ...
        ConfigUtils.create(this.config).getApplicationStatics(function (url, path) {
            _this.exportStatic(url, path);
    ...
    ExpressManager.prototype.exportStatic = function (url, path) {

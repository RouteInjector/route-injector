    ...
    ModelsLoader.prototype.compileSchemasToModels = function () {
        ...
        keys.forEach(function (modelName) {
            ...
            if (_this.models[modelName].baseModel) {
                ...
                var baseModelObject = mongoose.model(baseModel, _this.models[baseModel].schema);
                ...
                _this.models[modelName] = mongoose.model(modelName, _this.models[modelName].schema);
            }
        });
        ModelsLoader.logger.debug("");
    };

...
var GalleryInjector = /** @class */ (function () {
    ...
    GalleryInjector.prototype.handleGetImage = function () {
        ...
        this.routeInjector.app.use(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            var detectSize, fileName, fileAbs, maybeSize, size, widthStr, heightStr, width, height, fileNameNoExt, outputDir, outputFile, err_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 12, , 13]);
                        if (!req.url.startsWith(this.prefix + this.galleryEndpoint)) return [3 /*break*/, 10];
                        detectSize = /^[0-9]+x[0-9]*$|^[0-9]*x[0-9]+$|^[0-9]+x[0-9]+$/;
                        fileName = req.url.replace(this.prefix + this.galleryEndpoint, "").split("/");

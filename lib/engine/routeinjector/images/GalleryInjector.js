...
var GalleryInjector = (function () {
    ...
    GalleryInjector.prototype.handleGetImagesList = function () {
        this.routeInjector.app.get(this.galleryEndpoint + "/:path(*)", this.getUserIfExists.middleware, this.checkRole(this.listDirectoryRoles).middleware, this.fileExistsMiddleware, function (req, res, next) {
    ...
    GalleryInjector.prototype.handlePostImage = function () {
        var _this = this;
        this.routeInjector.app.post(this.galleryEndpoint + "/:path(*)", this.getUserIfExists.middleware, this.checkRole(this.postImageRoles).middleware, this.upload.array("images"), function (req, res, next) {
            var files = req.files;
            var i = 0;
    ...
    GalleryInjector.prototype.handleDeleteImage = function () {
        this.routeInjector.app.delete(this.galleryEndpoint + "/:path(*)", this.getUserIfExists.middleware, this.checkRole(this.deleteImageRoles).middleware, this.fileExistsMiddleware, function (req, res, next) {
